...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Atlas Desktop…'
    },
    errors: {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'profile.default': 'Switch to default worker',
      'profile.switch.1': 'Switch to worker 1',
      'profile.switch.2': 'Switch to worker 2',
      'profile.switch.3': 'Switch to worker 3',
      'profile.switch.4': 'Switch to worker 4',
      'profile.switch.5': 'Switch to worker 5',
      'profile.switch.6': 'Switch to worker 6',
      'profile.switch.7': 'Switch to worker 7',
      'profile.switch.8': 'Switch to worker 8',
      'profile.switch.9': 'Switch to worker 9',
      'profile.switch.10': 'Switch to worker 10',
      'profile.switch.11': 'Switch to worker 11',
      'profile.switch.12': 'Switch to worker 12',
      'profile.switch.13': 'Switch to worker 13',
      'profile.switch.14': 'Switch to worker 14',
      'profile.switch.15': 'Switch to worker 15',
      'profile.switch.16': 'Switch to worker 16',
      'profile.switch.17': 'Switch to worker 17',
      'profile.switch.18': 'Switch to worker 18',
      'profile.next': 'Next worker',
      'profile.prev': 'Previous worker',
      'profile.toggleAll': 'Toggle all-workers view',
      'profile.create': 'Create worker',
  ...
  starmap: {
    ...
    cortex: {
      ...
      nebula: {
        ariaLabel: 'Atlas memory nebula with the main brain and every worker brain woven into one sky.',
        backToNebula: 'Whole sky',
        clickToInspect: 'click to inspect',
        cortexDisabled: 'Cortex off',
        description: 'One living nebula. Atlas and every worker weave into the same sky.',
        ...
        emptySkyDescription: 'Brains with no memory stay visible in the filter bar without invented stars.',
        emptySkyTitle: 'The sky is quiet for now',
        eyebrow: 'Atlas cognition network',
        filterByBrain: 'Filter the nebula by brain',
        filterToBrain: brain => `Highlight ${brain} and dim other brains`,
        isolateBrain: brain => `Open ${brain} in the full brain view`,
        noMemoryYet: 'No memory yet',
        nodes: count => `${count} ${count === 1 ? 'node' : 'nodes'}`,
        ownerBrain: brain => `${brain} brain`,
        showWholeSky: 'Show the whole sky',
        title: 'Memory',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Atlas ${version} · Active sessions ${count}`,
  ...
  channels: {
    ...
    newChannel: 'Create channel or DM',
    emptyChannels: 'No channels yet',
    emptyDms: 'No direct messages yet',
    createTitle: 'Create an Atlas Team',
    createDescription: 'Choose a persistent channel or open a direct line to one worker.',
    kindLabel: 'Conversation type',
    kindChannel: 'Channel',
    kindChannelDescription: 'A named workspace for the user and one or more workers.',
    kindDm: 'Direct message',
    kindDmDescription: 'A focused conversation with one worker.',
    nameLabel: 'Channel name',
    namePlaceholder: 'service-reports',
    nameRequired: 'Enter a channel name.',
    membersLabel: 'Workers',
    membersHint: 'Choose one or more workers. You are always a member.',
    dmMemberHint: 'Choose the worker you want to message.',
    membersRequired: 'Choose at least one worker.',
    loadingWorkers: 'Loading workers…',
    failedLoadWorkers: 'Workers could not be loaded.',
    noWorkers: 'No workers are available yet.',
    workerFallbackRole: 'Atlas worker',
    createAction: 'Create channel',
    createDmAction: 'Create DM',
    userName: 'You',
    userAvatarLabel: 'YOU',
    memberCount: count => `${count} members`,
    transcriptLabel: 'Channel messages',
    emptyTranscriptTitle: 'Start the conversation',
    emptyChannelTranscriptDescription:
      'Mention a worker to wake them. Each worker replies from their own persistent, isolated session.',
    emptyDmTranscriptDescription: worker =>
      `Messages here go directly to ${worker} in one persistent, isolated session. No @mention is needed.`,
    noActiveMembersTitle: 'No active workers remain',
    noActiveMembersDescription:
      'This channel’s workers were deleted or are unavailable. Messages are still recorded, but nobody can be woken.',
    mentionWorker: 'Mention a worker',
    mentionNoMatches: 'No channel members match that name.',
    composerPlaceholder: channel => `Message #${channel}`,
    composerHint: 'Mention-only · use @ to wake a worker',
    dmComposerHint: 'Direct message · this worker wakes on every send',
    noMentionHint: 'Message recorded · no worker was mentioned',
    sendMessage: 'Send message',
    sending: 'Workers are responding…',
    responding: 'responding',
    deliveryError: 'delivery error',
    workerMissing: workerId => `Worker “${workerId}” no longer exists. This message was not delivered.`,
    workerFailed: (worker, detail) => `${worker} could not respond: ${detail}`,
    workerEmptyResponse: worker => `${worker} completed the turn without a response.`,
    settings: 'Channel settings',
    settingsDescription: 'Routing keeps one durable, isolated session per worker in this channel.',
    turnPolicyMentionOnly: 'Mention only',
    turnPolicyMentionOnlyDescription: 'Workers wake only when they are explicitly @mentioned.',
    dmTurnPolicyDescription: 'A direct message always wakes its single worker; @mentions are optional.',
    archive: 'Archive channel',
    notFoundTitle: 'Channel not found',
    notFoundDescription: 'This channel may have been archived or removed from this workstation.',
  ...
  profiles: {
    ...
    searchHint: name => `Try “${name}”`,
    noSearchResults: query => `No workers match “${query}”.`,
    loading: 'Loading workers...',
    newProfile: 'New worker',
    allProfiles: 'All workers',
    showAllProfiles: 'Show all workers',
    switchToProfile: name => `Switch to ${name}`,
    manageProfiles: 'Manage workers…',
    actionsFor: name => `Actions for ${name}`,
    color: 'Color…',
    colorFor: name => `Color for ${name}`,
    setColor: color => `Set color ${color}`,
    autoColor: 'Auto',
    noProfiles: 'No workers yet.',
    selectPrompt: 'Select a worker to view their details.',
    refresh: 'Refresh workers',
    refreshing: 'Refreshing workers',
    default: 'default',
    skills: count => `${count} ${count === 1 ? 'skill' : 'skills'}`,
    skillsShort: count => `${count} ${count === 1 ? 'skill' : 'skills'}`,
    env: 'env',
    ...
    copying: 'Copying...',
    modelLabel: 'Model',
    modelSectionDesc: 'Used for new chats with this worker, including channels and DMs.',
    changeModel: 'Change model',
    savingModel: 'Saving...',
    modelSaved: 'Worker model saved',
    failedLoadModel: 'Could not load this worker’s model.',
    failedSaveModel: 'Could not change or confirm this worker’s model. The previous model is still shown.',
    modelNeedsSetupBadge: 'Needs setup',
    modelNeedsApiKey: provider => `${provider} needs an API key in this worker before it can chat.`,
    providerNotReady: provider => `${provider} is not connected for this worker.`,
    configuredProvidersOnly: 'The picker only shows providers connected for this worker.',
    sameAsAtlas: 'Same as Atlas',
    createModelDesc: 'Use Atlas’s chat model, or choose a different one now. You can change it later.',
    chooseModel: 'Choose model',
    useAtlasModel: 'Use Atlas model',
    skillsLabel: 'Skills',
    runtimeSection: 'Worker environment',
    runtimeDesc: 'Read-only details from this worker’s local Atlas environment.',
    statusLabel: 'Status',
    workerHomeLabel: 'Worker home',
    notSet: 'Not set',
    identitySection: 'Worker identity',
    identityDesc: 'The name, role, and face your team sees across Atlas.',
    loadingIdentity: 'Loading worker identity...',
    displayNameLabel: 'Display name',
    displayNamePlaceholder: 'Riley',
    roleLabel: 'Role',
    rolePlaceholder: 'Service Advisor',
    taglineLabel: 'Tagline',
    taglinePlaceholder: 'Keeps every repair order moving.',
    characterCount: (count, limit) => `${count}/${limit}`,
    identityFieldTooLong: (label, limit) => `${label} must be ${limit} characters or fewer.`,
    saveIdentity: 'Save identity',
    identitySaved: 'Worker identity saved',
    failedLoadIdentity: 'Failed to load worker identity',
    failedSaveIdentity: 'Failed to save worker identity',
    avatarLabel: 'Portrait',
    avatarDesc: 'PNG, JPEG, or WebP. Maximum 5 MB.',
    uploadAvatar: 'Upload portrait',
    replaceAvatar: 'Replace portrait',
    uploadingAvatar: 'Uploading...',
    avatarInvalidType: 'Choose a PNG, JPEG, or WebP image.',
    avatarTooLarge: 'That image is larger than 5 MB. Choose a smaller file.',
    avatarUploaded: 'Worker portrait updated',
    ...
    avatarGenerated: 'Worker portrait generated',
    failedGenerateAvatar: 'Failed to generate worker portrait',
    soulDesc: 'The system prompt and persona instructions that guide this worker.',
    soulOptional: 'optional',
    soulPlaceholder: mode => `The system prompt / persona for this worker.\nLeave blank to keep the ${mode} default.`,
    ...
    cloneFromDesc: 'Copies config, skills, and SOUL.md from the selected worker.',
    ...
    next: 'Next',
    back: 'Back',
    renameTitle: 'Rename worker',
    renameDescPrefix: 'Renaming updates the worker directory and any wrapper scripts in ',
    renameDescSuffix: '.',
    newNameLabel: 'New name',
    renaming: 'Renaming...',
    created: 'Worker created',
    renamed: 'Worker renamed',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Atlas won’t ask again for commands like this — in this session or any future one.`,
