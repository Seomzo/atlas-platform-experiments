...
export const en: Translations = {
  ...
  channels: {
    ...
    scaffoldBadge: 'Visual scaffold',
    routingInactiveTitle: 'Channel routing is not yet active',
    routingInactiveDescription:
      'This shared workspace is ready for the routing engine. No worker is called and no response is simulated here.',
    dmReadyTitle: 'A live worker chat is available',
    dmReadyDescription: worker =>
      `Open a real one-to-one session with ${worker}. The session stays isolated in that worker’s own context.`,
    openWorkerChat: worker => `Open live chat with ${worker}`,
    mentionWorker: 'Mention a worker',
    composerPlaceholder: channel => `Message #${channel}`,
    composerPending: 'Draft only · channel routing is not active',
    dmComposerPending: 'Use the live worker chat to send messages',
    sendUnavailable: 'Sending from channels is not available yet',
    settings: 'Channel settings',
    settingsDescription: 'These settings are stored now and will be enforced by the routing engine later.',
    ...
    turnPolicyAllMembers: 'All members',
    turnPolicyAllMembersDescription: 'Every worker would receive each user turn. Routing is not active yet.',
