...
export const zhHant = defineLocale({
  ...
  channels: {
    ...
    scaffoldBadge: '介面鷹架',
    routingInactiveTitle: '頻道路由尚未啟用',
    routingInactiveDescription: '共享工作區介面已準備好。這裡不會呼叫員工，也不會模擬任何回覆。',
    dmReadyTitle: '可以開啟即時員工對話',
    dmReadyDescription: worker => `與 ${worker} 開啟真實的一對一工作階段。工作階段會保留在該員工自己的獨立上下文中。`,
    openWorkerChat: worker => `與 ${worker} 開始即時對話`,
    mentionWorker: '提及員工',
    composerPlaceholder: channel => `傳送訊息至 #${channel}`,
    composerPending: '僅草稿 · 頻道路由尚未啟用',
    dmComposerPending: '請在即時員工對話中傳送訊息',
    sendUnavailable: '暫時無法從頻道傳送訊息',
    settings: '頻道設定',
    settingsDescription: '這些設定會立即儲存，並由後續的路由引擎執行。',
    turnPolicy: '輪次策略',
    turnPolicyMentionOnly: '僅提及時',
    turnPolicyMentionOnlyDescription: '只有被明確 @提及的員工才會啟動。',
    turnPolicyAllMembers: '所有成員',
    turnPolicyAllMembersDescription: '每位員工都會收到每個使用者輪次。路由目前尚未啟用。',
    archive: '封存頻道',
    notFoundTitle: '找不到頻道',
