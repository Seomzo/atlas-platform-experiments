...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在啟動 Atlas Desktop…'
    },
    errors: {
  ...
  starmap: {
    ...
    cortex: {
      ...
      clearFilters: '清除篩選',
      nebula: {
        ariaLabel: 'Atlas 記憶星雲：主大腦與所有工作單元大腦交織在同一片星空中。',
        backToNebula: '整片星空',
        clickToInspect: '點擊查看詳情',
        cortexDisabled: 'Cortex 已關閉',
        description: '一片鮮活的星雲。Atlas 與所有工作單元交織在同一片星空中。',
        disabledBrainDescription: brain => `${brain} 已關閉 Cortex。為此工作單元啟用 Cortex 後即可建立記憶。`,
        disabledBrainTitle: 'Cortex 已關閉',
        emptySkyDescription: '尚無記憶的大腦仍會顯示在篩選列中，但不會產生虛假星點。',
        emptySkyTitle: '星空暫時安靜',
        eyebrow: 'Atlas 認知網路',
        filterByBrain: '依大腦篩選星雲',
        filterToBrain: brain => `醒目顯示 ${brain} 並淡化其他大腦`,
        isolateBrain: brain => `在完整大腦檢視中開啟 ${brain}`,
        noMemoryYet: '尚無記憶',
        nodes: count => `${count} 個節點`,
        ownerBrain: brain => `${brain} 大腦`,
        showWholeSky: '顯示整片星空',
        title: '記憶',
        unavailable: '暫不可用',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Atlas ${version} · 活躍工作階段 ${count}`,
  ...
  channels: {
    ...
    emptyChannels: '尚無頻道',
    emptyDms: '尚無私訊',
    createTitle: '建立 Atlas 團隊',
    createDescription: '建立持久頻道，或與一位員工開啟私訊。',
    kindLabel: '對話類型',
    kindChannel: '頻道',
    kindChannelDescription: '供你和一位或多位員工協作的命名工作區。',
    kindDm: '私訊',
    kindDmDescription: '與一位員工進行專注的一對一對話。',
    nameLabel: '頻道名稱',
    namePlaceholder: 'service-reports',
    nameRequired: '請輸入頻道名稱。',
    membersLabel: '員工',
    membersHint: '選擇一位或多位員工。你永遠是成員。',
    dmMemberHint: '選擇你想聯絡的員工。',
    membersRequired: '請至少選擇一位員工。',
    loadingWorkers: '正在載入員工…',
    failedLoadWorkers: '無法載入員工。',
    noWorkers: '目前沒有可用員工。',
    workerFallbackRole: 'Atlas 員工',
    createAction: '建立頻道',
    createDmAction: '建立私訊',
    userName: '你',
    userAvatarLabel: '你',
    memberCount: count => `${count} 位成員`,
    transcriptLabel: '頻道訊息',
    emptyTranscriptTitle: '開始對話',
    emptyChannelTranscriptDescription: '提及一位員工即可喚醒對方。每位員工都會從自己持久且隔離的工作階段回覆。',
    emptyDmTranscriptDescription: worker => `這裡的訊息會透過一個持久且隔離的工作階段直接傳給 ${worker}，無需 @提及。`,
    noActiveMembersTitle: '沒有可用的員工',
    noActiveMembersDescription: '此頻道的員工已被刪除或目前無法使用。訊息仍會記錄，但不會喚醒任何人。',
    mentionWorker: '提及員工',
    mentionNoMatches: '沒有頻道成員符合該名稱。',
    composerPlaceholder: channel => `傳送訊息至 #${channel}`,
    composerHint: '僅提及時回覆 · 使用 @ 喚醒員工',
    dmComposerHint: '私訊 · 每次傳送都會喚醒這位員工',
    noMentionHint: '訊息已記錄 · 未提及任何員工',
    sendMessage: '傳送訊息',
    sending: '員工正在回覆…',
    responding: '正在回覆',
    deliveryError: '傳送錯誤',
    workerMissing: workerId => `員工「${workerId}」已不存在，此訊息未送達。`,
    workerFailed: (worker, detail) => `${worker} 無法回覆：${detail}`,
    workerEmptyResponse: worker => `${worker} 已完成本輪，但沒有回覆。`,
    settings: '頻道設定',
    settingsDescription: '路由會為此頻道中的每位員工保留一個持久且隔離的工作階段。',
    turnPolicyMentionOnly: '僅提及時',
    turnPolicyMentionOnlyDescription: '只有被明確 @提及的員工才會啟動。',
    dmTurnPolicyDescription: '私訊永遠會喚醒唯一的員工；@提及為選用。',
    archive: '封存頻道',
    notFoundTitle: '找不到頻道',
    notFoundDescription: '此頻道可能已封存，或已從此工作站移除。',
    backToChat: '返回對話'
  },
  ...
  profiles: {
    ...
    search: '搜尋員工…',
    searchHint: name => `試試「${name}」`,
    noSearchResults: query => `沒有員工符合「${query}」。`,
    loading: '正在載入員工…',
    newProfile: '新增員工',
    allProfiles: '全部員工',
    showAllProfiles: '顯示全部員工',
    ...
    autoColor: '自動',
    noProfiles: '目前沒有員工。',
    selectPrompt: '選擇一位員工以檢視詳細資訊。',
    refresh: '重新整理員工',
    refreshing: '正在重新整理員工',
    default: '預設',
    skills: count => `${count} 個技能`,
    skillsShort: count => `${count} 個技能`,
    env: 'env',
    defaultBadge: '預設',
    currentBadge: '目前',
    onlineBadge: '在線',
    ...
    copying: '複製中…',
    modelLabel: '模型',
    modelSectionDesc: '用於與該員工的新對話，包括頻道和私訊。',
    changeModel: '變更模型',
    savingModel: '儲存中…',
    modelSaved: '員工模型已儲存',
    failedLoadModel: '無法載入該員工的模型。',
    failedSaveModel: '無法變更或確認該員工的模型，仍顯示先前的模型。',
    modelNeedsSetupBadge: '需要設定',
    modelNeedsApiKey: provider => `${provider} 需要在該員工中設定 API 金鑰後才能對話。`,
    providerNotReady: provider => `該員工尚未連接 ${provider}。`,
    configuredProvidersOnly: '選擇器僅顯示已為該員工連接的提供者。',
    sameAsAtlas: '與 Atlas 相同',
    createModelDesc: '使用 Atlas 的對話模型，或立即選擇其他模型。稍後仍可變更。',
    chooseModel: '選擇模型',
    useAtlasModel: '使用 Atlas 模型',
    skillsLabel: '技能',
    runtimeSection: '員工環境',
    runtimeDesc: '來自此員工本機 Atlas 環境的唯讀資訊。',
    statusLabel: '狀態',
    workerHomeLabel: '員工目錄',
    notSet: '未設定',
    identitySection: '員工身分',
    identityDesc: '團隊在 Atlas 中看到的姓名、角色與頭像。',
    loadingIdentity: '正在載入員工身分…',
    displayNameLabel: '顯示名稱',
    displayNamePlaceholder: '小林',
    roleLabel: '角色',
    rolePlaceholder: '服務顧問',
    taglineLabel: '簡介',
    taglinePlaceholder: '確保每張維修工單順利推進。',
    characterCount: (count, limit) => `${count}/${limit}`,
    identityFieldTooLong: (label, limit) => `${label}不得超過 ${limit} 個字元。`,
    saveIdentity: '儲存身分',
    identitySaved: '員工身分已儲存',
    failedLoadIdentity: '載入員工身分失敗',
    failedSaveIdentity: '儲存員工身分失敗',
    avatarLabel: '頭像',
    avatarDesc: '支援 PNG、JPEG 或 WebP，最大 5 MB。',
    uploadAvatar: '上傳頭像',
    replaceAvatar: '更換頭像',
    uploadingAvatar: '正在上傳…',
    avatarInvalidType: '請選擇 PNG、JPEG 或 WebP 圖片。',
    avatarTooLarge: '圖片超過 5 MB，請選擇較小的檔案。',
    avatarUploaded: '員工頭像已更新',
    failedUploadAvatar: '上傳員工頭像失敗',
    generateAvatar: '產生頭像',
    generateAvatarDesc: '描述員工的形象。Atlas 將使用您已設定的圖片提供者。',
    generatePromptPlaceholder: '現代汽車經銷店中的專業服務顧問，自然暖光，方形肖像…',
    generatePromptRequired: '請先描述員工的形象。',
    generateAction: '產生',
    regenerateAvatar: '重新產生',
    generatingAvatar: '正在產生…',
    avatarGenerated: '員工頭像已產生',
    failedGenerateAvatar: '產生員工頭像失敗',
    soulDesc: '引導這位員工的系統提示詞與角色指令。',
    soulOptional: '選填',
    soulPlaceholder: mode => `這位員工的系統提示詞 / 角色說明。\n留空則保留${mode}預設值。`,
    ...
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
    cloneFromDesc: '從選取的員工複製設定、技能和 SOUL.md。',
    ...
    back: '返回',
    renameTitle: '重新命名員工',
    renameDescPrefix: '重新命名會更新員工目錄以及 ',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.hermes/config.yaml）。Atlas 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
