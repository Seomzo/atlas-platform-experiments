...
export const zh: Translations = {
  ...
  channels: {
    ...
    scaffoldBadge: '界面脚手架',
    routingInactiveTitle: '频道路由尚未启用',
    routingInactiveDescription: '共享工作区界面已经就绪。这里不会调用员工，也不会模拟任何回复。',
    dmReadyTitle: '可以开启实时员工对话',
    dmReadyDescription: worker => `与 ${worker} 开启真实的一对一会话。该会话保留在这位员工自己的独立上下文中。`,
    openWorkerChat: worker => `与 ${worker} 开始实时对话`,
    mentionWorker: '提及员工',
    composerPlaceholder: channel => `发送消息到 #${channel}`,
    composerPending: '仅草稿 · 频道路由尚未启用',
    dmComposerPending: '请在实时员工对话中发送消息',
    sendUnavailable: '暂时无法从频道发送消息',
    settings: '频道设置',
    settingsDescription: '这些设置会立即保存，并由后续的路由引擎执行。',
    turnPolicy: '轮次策略',
    turnPolicyMentionOnly: '仅提及时',
    turnPolicyMentionOnlyDescription: '只有被明确 @提及的员工才会响应。',
    turnPolicyAllMembers: '所有成员',
    turnPolicyAllMembersDescription: '每位员工都会收到每个用户轮次。路由目前尚未启用。',
    archive: '归档频道',
    notFoundTitle: '未找到频道',
