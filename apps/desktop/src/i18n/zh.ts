...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在启动 Atlas 桌面版…'
    },
    errors: {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'profile.default': '切换到默认员工',
      'profile.switch.1': '切换到员工 1',
      'profile.switch.2': '切换到员工 2',
      'profile.switch.3': '切换到员工 3',
      'profile.switch.4': '切换到员工 4',
      'profile.switch.5': '切换到员工 5',
      'profile.switch.6': '切换到员工 6',
      'profile.switch.7': '切换到员工 7',
      'profile.switch.8': '切换到员工 8',
      'profile.switch.9': '切换到员工 9',
      'profile.switch.10': '切换到员工 10',
      'profile.switch.11': '切换到员工 11',
      'profile.switch.12': '切换到员工 12',
      'profile.switch.13': '切换到员工 13',
      'profile.switch.14': '切换到员工 14',
      'profile.switch.15': '切换到员工 15',
      'profile.switch.16': '切换到员工 16',
      'profile.switch.17': '切换到员工 17',
      'profile.switch.18': '切换到员工 18',
      'profile.next': '下一个员工',
      'profile.prev': '上一个员工',
      'profile.toggleAll': '切换全部员工视图',
      'profile.create': '创建员工',
      'composer.send': '发送消息',
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 Atlas 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Atlas Desktop 将使用已保存设置重新连接。',
  ...
  starmap: {
    ...
    cortex: {
      ...
      clearFilters: '清除筛选',
      nebula: {
        ariaLabel: 'Atlas 记忆星云：主大脑与所有工作单元大脑交织在同一片星空中。',
        backToNebula: '整片星空',
        clickToInspect: '点击查看详情',
        cortexDisabled: 'Cortex 已关闭',
        description: '一片鲜活的星云。Atlas 与所有工作单元交织在同一片星空中。',
        disabledBrainDescription: brain => `${brain} 已关闭 Cortex。为此工作单元启用 Cortex 后即可构建记忆。`,
        disabledBrainTitle: 'Cortex 已关闭',
        emptySkyDescription: '尚无记忆的大脑仍会显示在筛选栏中，但不会生成虚假星点。',
        emptySkyTitle: '星空暂时安静',
        eyebrow: 'Atlas 认知网络',
        filterByBrain: '按大脑筛选星云',
        filterToBrain: brain => `高亮 ${brain} 并淡化其他大脑`,
        isolateBrain: brain => `在完整大脑视图中打开 ${brain}`,
        noMemoryYet: '尚无记忆',
        nodes: count => `${count} 个节点`,
        ownerBrain: brain => `${brain} 大脑`,
        showWholeSky: '显示整片星空',
        title: '记忆',
        unavailable: '暂不可用',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Atlas ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      weixin:
        '运行 `hermes gateway setup`，选择 Weixin，然后使用个人微信账号扫描并确认二维码。Atlas 会通过腾讯 iLink Bot API 连接并保存凭据。',
  ...
  channels: {
    ...
    emptyChannels: '暂无频道',
    emptyDms: '暂无私信',
    createTitle: '创建 Atlas 团队',
    createDescription: '创建一个持久频道，或与一位员工开启私信。',
    kindLabel: '对话类型',
    kindChannel: '频道',
    kindChannelDescription: '供你和一位或多位员工协作的命名工作区。',
    kindDm: '私信',
    kindDmDescription: '与一位员工进行专注的一对一对话。',
    nameLabel: '频道名称',
    namePlaceholder: 'service-reports',
    nameRequired: '请输入频道名称。',
    membersLabel: '员工',
    membersHint: '选择一位或多位员工。你始终是成员。',
    dmMemberHint: '选择你想联系的员工。',
    membersRequired: '请至少选择一位员工。',
    loadingWorkers: '正在加载员工…',
    failedLoadWorkers: '无法加载员工。',
    noWorkers: '目前没有可用员工。',
    workerFallbackRole: 'Atlas 员工',
    createAction: '创建频道',
    createDmAction: '创建私信',
    userName: '你',
    userAvatarLabel: '你',
    memberCount: count => `${count} 位成员`,
    transcriptLabel: '频道消息',
    emptyTranscriptTitle: '开始对话',
    emptyChannelTranscriptDescription: '提及一位员工以唤醒对方。每位员工都从自己持久且隔离的会话中回复。',
    emptyDmTranscriptDescription: worker => `这里的消息会通过一个持久且隔离的会话直接发送给 ${worker}，无需 @提及。`,
    noActiveMembersTitle: '没有可用的员工',
    noActiveMembersDescription: '此频道的员工已被删除或当前不可用。消息仍会被记录，但不会唤醒任何人。',
    mentionWorker: '提及员工',
    mentionNoMatches: '没有频道成员匹配该名称。',
    composerPlaceholder: channel => `发送消息到 #${channel}`,
    composerHint: '仅提及时响应 · 使用 @ 唤醒员工',
    dmComposerHint: '私信 · 每次发送都会唤醒这位员工',
    noMentionHint: '消息已记录 · 未提及任何员工',
    sendMessage: '发送消息',
    sending: '员工正在回复…',
    responding: '正在回复',
    deliveryError: '发送错误',
    workerMissing: workerId => `员工“${workerId}”已不存在，此消息未送达。`,
    workerFailed: (worker, detail) => `${worker} 无法回复：${detail}`,
    workerEmptyResponse: worker => `${worker} 已完成本轮，但没有返回回复。`,
    settings: '频道设置',
    settingsDescription: '路由会为此频道中的每位员工保留一个持久且隔离的会话。',
    turnPolicyMentionOnly: '仅提及时',
    turnPolicyMentionOnlyDescription: '只有被明确 @提及的员工才会响应。',
    dmTurnPolicyDescription: '私信始终会唤醒其唯一员工；@提及为可选项。',
    archive: '归档频道',
    notFoundTitle: '未找到频道',
    notFoundDescription: '此频道可能已归档，或已从此工作站移除。',
    backToChat: '返回对话'
  },
  ...
  profiles: {
    ...
    search: '搜索员工…',
    searchHint: name => `试试“${name}”`,
    noSearchResults: query => `没有员工匹配“${query}”。`,
    loading: '正在加载员工…',
    newProfile: '新建员工',
    allProfiles: '全部员工',
    showAllProfiles: '显示全部员工',
    ...
    autoColor: '自动',
    noProfiles: '暂无员工。',
    selectPrompt: '选择一位员工以查看详情。',
    refresh: '刷新员工',
    refreshing: '正在刷新员工',
    default: '默认',
    skills: count => `${count} 个技能`,
    skillsShort: count => `${count} 个技能`,
    env: 'env',
    defaultBadge: '默认',
    currentBadge: '当前',
    onlineBadge: '在线',
    ...
    copying: '复制中…',
    modelLabel: '模型',
    modelSectionDesc: '用于与该员工的新对话，包括频道和私信。',
    changeModel: '更换模型',
    savingModel: '保存中…',
    modelSaved: '员工模型已保存',
    failedLoadModel: '无法加载该员工的模型。',
    failedSaveModel: '无法更换或确认该员工的模型，仍显示之前的模型。',
    modelNeedsSetupBadge: '需要设置',
    modelNeedsApiKey: provider => `${provider} 需要在该员工中配置 API 密钥后才能对话。`,
    providerNotReady: provider => `该员工尚未连接 ${provider}。`,
    configuredProvidersOnly: '选择器仅显示已为该员工连接的提供方。',
    sameAsAtlas: '与 Atlas 相同',
    createModelDesc: '使用 Atlas 的对话模型，或立即选择其他模型。稍后仍可更改。',
    chooseModel: '选择模型',
    useAtlasModel: '使用 Atlas 模型',
    skillsLabel: '技能',
    runtimeSection: '员工环境',
    runtimeDesc: '来自此员工本地 Atlas 环境的只读信息。',
    statusLabel: '状态',
    workerHomeLabel: '员工目录',
    notSet: '未设置',
    identitySection: '员工身份',
    identityDesc: '团队在 Atlas 中看到的姓名、角色和头像。',
    loadingIdentity: '正在加载员工身份…',
    displayNameLabel: '显示名称',
    displayNamePlaceholder: '小林',
    roleLabel: '角色',
    rolePlaceholder: '服务顾问',
    taglineLabel: '简介',
    taglinePlaceholder: '确保每张维修工单顺利推进。',
    characterCount: (count, limit) => `${count}/${limit}`,
    identityFieldTooLong: (label, limit) => `${label}不得超过 ${limit} 个字符。`,
    saveIdentity: '保存身份',
    identitySaved: '员工身份已保存',
    failedLoadIdentity: '加载员工身份失败',
    failedSaveIdentity: '保存员工身份失败',
    avatarLabel: '头像',
    avatarDesc: '支持 PNG、JPEG 或 WebP，最大 5 MB。',
    uploadAvatar: '上传头像',
    replaceAvatar: '更换头像',
    uploadingAvatar: '正在上传…',
    avatarInvalidType: '请选择 PNG、JPEG 或 WebP 图片。',
    avatarTooLarge: '图片超过 5 MB，请选择更小的文件。',
    avatarUploaded: '员工头像已更新',
    failedUploadAvatar: '上传员工头像失败',
    generateAvatar: '生成头像',
    generateAvatarDesc: '描述员工的形象。Atlas 将使用你已配置的图像提供方。',
    generatePromptPlaceholder: '现代汽车经销店中的专业服务顾问，自然暖光，方形肖像…',
    generatePromptRequired: '请先描述员工的形象。',
    generateAction: '生成',
    regenerateAvatar: '重新生成',
    generatingAvatar: '正在生成…',
    avatarGenerated: '员工头像已生成',
    failedGenerateAvatar: '生成员工头像失败',
    soulDesc: '指导这位员工的系统提示词与人格指令。',
    soulOptional: '可选',
    soulPlaceholder: mode => `这位员工的系统提示词 / 人格说明。\n留空则保留${mode}默认值。`,
    ...
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
    cloneFromDesc: '从选中的员工复制配置、技能和 SOUL.md。',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.hermes/config.yaml)。Atlas 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
