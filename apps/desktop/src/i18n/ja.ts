...
export const ja = defineLocale({
  ...
  channels: {
    ...
    scaffoldBadge: 'UI スキャフォールド',
    routingInactiveTitle: 'チャンネルルーティングはまだ有効ではありません',
    routingInactiveDescription:
      '共有ワークスペースの画面だけが準備されています。ワーカーの呼び出しや応答の模倣は行いません。',
    dmReadyTitle: '実際のワーカーチャットを開けます',
    dmReadyDescription: worker =>
      `${worker} と実際の 1 対 1 セッションを開きます。セッションはそのワーカー固有のコンテキストに分離されます。`,
    openWorkerChat: worker => `${worker} とライブチャットを開く`,
    mentionWorker: 'ワーカーをメンション',
    composerPlaceholder: channel => `#${channel} にメッセージ`,
    composerPending: '下書きのみ · チャンネルルーティングは未実装',
    dmComposerPending: 'ライブワーカーチャットから送信してください',
    sendUnavailable: 'チャンネルからの送信はまだ利用できません',
    settings: 'チャンネル設定',
    settingsDescription: '設定は今すぐ保存され、後続のルーティングエンジンで適用されます。',
    turnPolicy: 'ターンポリシー',
    turnPolicyMentionOnly: 'メンションのみ',
    turnPolicyMentionOnlyDescription: '明示的に @メンションされたワーカーだけが起動します。',
    turnPolicyAllMembers: 'すべてのメンバー',
    turnPolicyAllMembersDescription: 'すべてのワーカーが各ユーザーターンを受け取ります。ルーティングはまだ無効です。',
    archive: 'チャンネルをアーカイブ',
