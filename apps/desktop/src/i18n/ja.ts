...
export const ja = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Atlas Desktop を起動中…'
    },
    errors: {
  ...
  starmap: {
    ...
    cortex: {
      ...
      nebula: {
        ariaLabel: 'Atlas のメインブレインとすべてのワーカーブレインが一つの空に織り込まれたメモリ星雲。',
        backToNebula: '空全体',
        clickToInspect: 'クリックして詳細を表示',
        cortexDisabled: 'Cortex オフ',
        description: '一つの生きた星雲。Atlas とすべてのワーカーが同じ空に織り込まれます。',
        disabledBrainDescription: brain =>
          `${brain} は Cortex がオフです。このワーカーで Cortex を有効にするとメモリを構築できます。`,
        disabledBrainTitle: 'Cortex はオフです',
        emptySkyDescription: 'メモリのないブレインもフィルターバーに残りますが、偽のスターは表示しません。',
        emptySkyTitle: '今は静かな空です',
        eyebrow: 'Atlas 認知ネットワーク',
        filterByBrain: 'ブレインで星雲を絞り込む',
        filterToBrain: brain => `${brain} を強調して他のブレインを暗くする`,
        isolateBrain: brain => `${brain} を完全なブレインビューで開く`,
        noMemoryYet: 'メモリはまだありません',
        nodes: count => `${count} ノード`,
        ownerBrain: brain => `${brain} ブレイン`,
        showWholeSky: '空全体を表示',
        title: 'メモリ',
        unavailable: '利用不可',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Atlas ${version} · アクティブセッション ${count}`,
  ...
  channels: {
    ...
    newChannel: 'チャンネルまたは DM を作成',
    emptyChannels: 'チャンネルはまだありません',
    emptyDms: 'ダイレクトメッセージはまだありません',
    createTitle: 'Atlas Team を作成',
    createDescription: '永続チャンネルを作成するか、1 人のワーカーとダイレクトに会話します。',
    kindLabel: '会話タイプ',
    kindChannel: 'チャンネル',
    kindChannelDescription: 'あなたと 1 人以上のワーカーが参加する名前付きワークスペースです。',
    kindDm: 'ダイレクトメッセージ',
    kindDmDescription: '1 人のワーカーとの集中した会話です。',
    nameLabel: 'チャンネル名',
    namePlaceholder: 'service-reports',
    nameRequired: 'チャンネル名を入力してください。',
    membersLabel: 'ワーカー',
    membersHint: '1 人以上のワーカーを選択してください。あなたは常にメンバーです。',
    dmMemberHint: 'メッセージを送るワーカーを選択してください。',
    membersRequired: 'ワーカーを 1 人以上選択してください。',
    loadingWorkers: 'ワーカーを読み込み中…',
    failedLoadWorkers: 'ワーカーを読み込めませんでした。',
    noWorkers: '利用できるワーカーがまだいません。',
    workerFallbackRole: 'Atlas ワーカー',
    createAction: 'チャンネルを作成',
    createDmAction: 'DM を作成',
    userName: 'あなた',
    userAvatarLabel: 'YOU',
    memberCount: count => `${count} 人のメンバー`,
    transcriptLabel: 'チャンネルメッセージ',
    emptyTranscriptTitle: '会話を始める',
    emptyChannelTranscriptDescription:
      'ワーカーをメンションすると起動します。各ワーカーは固有の永続的で分離されたセッションから返信します。',
    emptyDmTranscriptDescription: worker =>
      `ここでのメッセージは、永続的で分離された 1 つのセッションで ${worker} に直接届きます。@メンションは不要です。`,
    noActiveMembersTitle: '有効なワーカーがいません',
    noActiveMembersDescription:
      'このチャンネルのワーカーは削除されたか利用できません。メッセージは記録されますが、誰も起動しません。',
    mentionWorker: 'ワーカーをメンション',
    mentionNoMatches: 'その名前に一致するチャンネルメンバーはいません。',
    composerPlaceholder: channel => `#${channel} にメッセージ`,
    composerHint: 'メンションのみ · @ でワーカーを起動',
    dmComposerHint: 'ダイレクトメッセージ · 送信ごとにこのワーカーが起動',
    noMentionHint: 'メッセージを記録しました · ワーカーはメンションされていません',
    sendMessage: 'メッセージを送信',
    sending: 'ワーカーが返信中…',
    responding: '返信中',
    deliveryError: '配信エラー',
    workerMissing: workerId => `ワーカー「${workerId}」は存在しません。このメッセージは配信されませんでした。`,
    workerFailed: (worker, detail) => `${worker} は返信できませんでした：${detail}`,
    workerEmptyResponse: worker => `${worker} はターンを完了しましたが、返信はありませんでした。`,
    settings: 'チャンネル設定',
    settingsDescription: 'このチャンネルでは、ワーカーごとに永続的で分離されたセッションを維持します。',
    turnPolicyMentionOnly: 'メンションのみ',
    turnPolicyMentionOnlyDescription: '明示的に @メンションされたワーカーだけが起動します。',
    dmTurnPolicyDescription: 'ダイレクトメッセージは常に 1 人のワーカーを起動します。@メンションは任意です。',
    archive: 'チャンネルをアーカイブ',
    notFoundTitle: 'チャンネルが見つかりません',
    notFoundDescription: 'このチャンネルはアーカイブされたか、このワークステーションから削除された可能性があります。',
    backToChat: 'チャットに戻る'
  },
  ...
  profiles: {
    ...
    search: 'ワーカーを検索...',
    searchHint: name => `「${name}」を検索`,
    noSearchResults: query => `「${query}」に一致するワーカーはいません。`,
    loading: 'ワーカーを読み込み中...',
    newProfile: '新しいワーカー',
    allProfiles: 'すべてのワーカー',
    showAllProfiles: 'すべてのワーカーを表示',
    switchToProfile: name => `${name} に切り替え`,
    manageProfiles: 'ワーカーを管理…',
    actionsFor: name => `${name} のアクション`,
    color: 'カラー…',
    colorFor: name => `${name} のカラー`,
    setColor: color => `カラー ${color} に設定`,
    autoColor: '自動',
    noProfiles: 'ワーカーはまだいません。',
    selectPrompt: '詳細を表示するワーカーを選択してください。',
    refresh: 'ワーカーを更新',
    refreshing: 'ワーカーを更新中',
    default: 'デフォルト',
    skills: count => `${count} スキル`,
    skillsShort: count => `${count} スキル`,
    env: 'env',
    defaultBadge: 'デフォルト',
    currentBadge: '使用中',
    onlineBadge: 'オンライン',
    ...
    copying: 'コピー中...',
    modelLabel: 'モデル',
    modelSectionDesc: 'チャンネルや DM を含む、このワーカーとの新しいチャットで使用します。',
    changeModel: 'モデルを変更',
    savingModel: '保存中...',
    modelSaved: 'ワーカーのモデルを保存しました',
    failedLoadModel: 'このワーカーのモデルを読み込めませんでした。',
    failedSaveModel: 'このワーカーのモデルを変更または確認できませんでした。以前のモデルを表示しています。',
    modelNeedsSetupBadge: '設定が必要',
    modelNeedsApiKey: provider => `${provider} を使用するには、このワーカーに API キーを設定してください。`,
    providerNotReady: provider => `${provider} はこのワーカーに接続されていません。`,
    configuredProvidersOnly: 'このワーカーに接続済みのプロバイダーのみ表示されます。',
    sameAsAtlas: 'Atlas と同じ',
    createModelDesc: 'Atlas のチャットモデルを使うか、別のモデルを選びます。後から変更できます。',
    chooseModel: 'モデルを選択',
    useAtlasModel: 'Atlas のモデルを使用',
    skillsLabel: 'スキル',
    runtimeSection: 'ワーカー環境',
    runtimeDesc: 'このワーカーのローカル Atlas 環境から取得した読み取り専用の情報です。',
    statusLabel: '状態',
    workerHomeLabel: 'ワーカーホーム',
    notSet: '未設定',
    identitySection: 'ワーカー情報',
    identityDesc: 'チームが Atlas で見る名前、役割、顔写真です。',
    loadingIdentity: 'ワーカー情報を読み込み中...',
    displayNameLabel: '表示名',
    displayNamePlaceholder: 'リリー',
    roleLabel: '役割',
    rolePlaceholder: 'サービスアドバイザー',
    taglineLabel: '紹介文',
    taglinePlaceholder: 'すべての修理オーダーを円滑に進めます。',
    characterCount: (count, limit) => `${count}/${limit}`,
    identityFieldTooLong: (label, limit) => `${label}は${limit}文字以内で入力してください。`,
    saveIdentity: 'ワーカー情報を保存',
    identitySaved: 'ワーカー情報を保存しました',
    failedLoadIdentity: 'ワーカー情報の読み込みに失敗しました',
    failedSaveIdentity: 'ワーカー情報の保存に失敗しました',
    avatarLabel: '顔写真',
    avatarDesc: 'PNG、JPEG、WebP。最大 5 MB。',
    uploadAvatar: '顔写真をアップロード',
    replaceAvatar: '顔写真を変更',
    uploadingAvatar: 'アップロード中...',
    avatarInvalidType: 'PNG、JPEG、または WebP 画像を選択してください。',
    avatarTooLarge: '画像が 5 MB を超えています。小さいファイルを選択してください。',
    avatarUploaded: 'ワーカーの顔写真を更新しました',
    ...
    generatingAvatar: '生成中...',
    avatarGenerated: 'ワーカーの顔写真を生成しました',
    failedGenerateAvatar: 'ワーカーの顔写真の生成に失敗しました',
    soulDesc: 'このワーカーを導くシステムプロンプトとペルソナの指示。',
    soulOptional: '省略可能',
    soulPlaceholder: mode =>
      `このワーカーのシステムプロンプト / ペルソナ。\n空欄のままにすると ${mode} のデフォルトを使用します。`,
    ...
    cloneFrom: '複製元',
    cloneFromNone: 'なし（空）',
    cloneFromDesc: '選択したワーカーから設定、スキル、SOUL.md をコピーします。',
    ...
    next: '次へ',
    back: '戻る',
    renameTitle: 'ワーカーの名前を変更',
    renameDescPrefix: '名前を変更するとワーカーディレクトリと ',
    ...
    failedLoad: 'ワーカーの読み込みに失敗しました',
    failedDelete: 'ワーカーの削除に失敗しました',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Atlas 推論ゲートウェイのステータス',
      agents: 'エージェント',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `これにより "${pattern}" パターンが永続的な許可リスト (~/.hermes/config.yaml) に追加されます。Atlas はこのセッションや将来のセッションで、このようなコマンドについて再度尋ねません。`,
      alwaysAllow: '常に許可'
    },
    clarify: {
