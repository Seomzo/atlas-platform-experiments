...
HERMES_AGENT_HELP_GUIDANCE = (
    (
        "You run on Atlas by DealerBox. When the user needs help with Atlas itself — "
        "configuring, setting up, using, extending, or troubleshooting it — use the "
        "bundled Atlas documentation and skills as the authoritative product reference."
    )
    if _ATLAS_BRANDED
    else (
