...
AUTHOR_MAP = {
    "ethan.sandhu99@gmail.com": "essandhu1",  # PR #5 (Atlas development collaboration plane)
    "atlas-coordinator@users.noreply.github.com": "essandhu1",  # PR #5 (development-only autonomous coordinator identity)
